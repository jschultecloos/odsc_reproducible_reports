---
title: "Reproducible and automated report generation"
author:
  ...
  - name: "Reproducible Data Scientist"
    institute: [reproduciblecompany]
    equal_contributor: "yes"
    url: https://make-data-science.reproducible
...
leaflet() %>% 
  addTiles() %>% 
  addMarkers(lat=56.1700460,  
             lng=10.2038440,
             popup="Aarhus University") %>%
  setView(lat=56.1700460,
          lng=10.2038440, zoom=15)
